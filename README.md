...
### LHOL - 3. Explore the DynamoDB console - Modifying Data
...
``
{
  ...
  "ReplyDateTime": {
    "S": "2021-04-27T17:47:30Z"
  },
  "Message": {
    "S": "DynamoDB Thread 2 Reply 3 text"
  },
  "PostedBy": {
    "S": "User C"
  }
...
### LDMS - Configure MySQL Environment
...
Resources:
  ...
  DBDMSInstanceProfile:
    Type: AWS::IAM::InstanceProfile
    Properties:
      InstanceProfileName: DBDMSInstanceProfile
      Path: /
      Roles:
       - !Ref DBDMSInstanceRole
  DBDMSInstanceRole:
    Type: AWS::IAM::Role
    Properties:
      RoleName: DBDMSInstanceRole
  ...
  DbInstance:
    ...
    Properties:
      ...
      SubnetId: !Ref DbSubnet
      IamInstanceProfile: !Ref DBDMSInstanceProfile
      BlockDeviceMappings:
        - DeviceName: /dev/xvda
          Ebs:
            VolumeType: gp2
